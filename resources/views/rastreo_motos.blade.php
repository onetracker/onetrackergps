    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-12" align="center">
			...
			<h2 id="mision">RASTREO DE MOTOS</h2>
			<p>La solución de localización y seguimiento más apropiada para un desplazamiento seguro para motos particulares, negocio y servicio público</p>

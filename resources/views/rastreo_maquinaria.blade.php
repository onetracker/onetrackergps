    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-12" align="center">
			...
			<h2 id="mision">RASTREO DE MAQUINARIA</h2>
			<p>Monitoreo, seguimiento y gestión en desarrollo y avances de grandes construcciones en todo tipo de topografías en tiempo real con precisión</p>
